...
public class PokemonService implements HttpService {
    ...
    public void routing(HttpRules rules) {
        rules.get("/", this::index)
                ...
                // Update name of existing Pok̩mon
                .put("/pokemon", Handler.create(Pokemon.class, this::updatePokemon))
                // Delete Pok̩mon by ID including type relation
    ...
    /**
     * Return JsonArray with all stored Pok̩mon.
     * Pok̩mon object contains list of all type names.
    ...
    /**
     * Insert new Pok̩mon with specified name.
     *
    ...
    /**
     * Delete Pok̩mon with specified id (key).
     *
     * @param request  the server request
     * @param response the server response
     */
